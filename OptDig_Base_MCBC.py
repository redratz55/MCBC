# -*- coding: utf-8 -*-
"""
Created on Fri Apr  1 10:52:08 2022
...
names = ["t"+str(i) for i in range(65)]
#Load first dataset
df = pd.read_csv("optdigits.TRA", index_col=False, skiprows = 1, names = names)
...
x_train, x_test, y_train, y_test = train_test_split(df.drop('t64',  axis = 1), df['t64'], random_state = 2)
