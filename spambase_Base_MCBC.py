# -*- coding: utf-8 -*-
"""
Created on Fri Apr  1 12:15:28 2022
...
names = ["t"+str(i) for i in range(58)]
#Load first dataset
df = pd.read_csv("spambase.data", index_col=False, skiprows = 1, names = names)
...
x_train, x_test, y_train, y_test = train_test_split(df.drop('t57',  axis = 1), df['t57'], random_state = 2)
