# -*- coding: utf-8 -*-
"""
Created on Fri Apr  1 04:09:56 2022
...
names = ["t"+str(i) for i in range(7)]
df = pd.read_csv("car.data", index_col=False, skiprows = 1, names = names)
...
x_train, x_test, y_train, y_test = train_test_split(df.drop('t6',  axis = 1), df['t6'], random_state = 2)
